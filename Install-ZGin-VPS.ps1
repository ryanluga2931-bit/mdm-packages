...
# --- [2] VipTalk ---
Write-Host ""
Write-Host "=== [2/4] VipTalk ===" -ForegroundColor Cyan
if (CheckReg "VipTalk") {
...
# --- [3] Signal ---
Write-Host ""
Write-Host "=== [3/4] Signal ===" -ForegroundColor Cyan
...
if (Test-Path $tgExe) {
    ...
    Download "Telegram 6.9.3" "https://github.com/telegramdesktop/tdesktop/releases/download/v6.9.3/tsetup-x64.6.9.3.exe" $f
    RunInstaller "Telegram" $f "/VERYSILENT /NORESTART"
}

# --- Ket qua ---
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host " HOAN TAT - Z Gin VPS" -ForegroundColor Green
