# ============================================================
# Cai app cho VPS T Sanel
# UniKey, Signal, Telegram
# ============================================================
...
# ============================================================
Write-Host ""
Write-Host "=== [3/3] Telegram ===" -ForegroundColor Cyan
...
Write-Host " HOAN TAT - T Sanel VPS" -ForegroundColor Green
Write-Host "  1. UniKey" -ForegroundColor White
Write-Host "  2. Signal" -ForegroundColor White
Write-Host "  3. Telegram" -ForegroundColor White
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
pause
